...
public class MenuTest {
	...
	@Test
	public void displays_a_list_of_purchase_options_and_prompts_user_to_make_a_choice() {
		
		Menu menu = getMenuForTesting();
		menu.getChoiceFromOptions(PurchaseMenu.getPurchaseMenuOptions());
		String expected = "\r\n" + "1) " + PurchaseMenu.getPurchaseMenuOptions()[0].toString() + "\r\n" + "2) " + PurchaseMenu.getPurchaseMenuOptions()[1].toString() + "\r\n" + "3) "
				+ PurchaseMenu.getPurchaseMenuOptions()[2].toString() + "\r\n\n" + "Current Money Provided: $" + Purchase.getCurrentMoney() + "\n\nPlease choose an option >>> ";
		assertEquals(expected, output.toString());
	}
